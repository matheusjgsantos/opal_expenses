...
def openFileBrowser():
    ...
    root = Tk()
    root.title("OPAL Expenses PDF importer")
    root.filename = tkFileDialog.askopenfilename(initialdir = "root", title = "Select Opal PDF report file",filetypes = (("PDF Files", "*.pdf"),("All files", "*.*")))
